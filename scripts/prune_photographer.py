#!/usr/bin/env python3
"""Manual pruner: remove photographer thumbnails and manifest entries for files
   no longer present in the photographer Drive folder. Not run by scheduled sync.
   Usage:  python scripts/prune_photographer.py [--dry-run]
"""
...
FOLDER_ID = os.environ["PHOTOG_DRIVE_FOLDER_ID"]
