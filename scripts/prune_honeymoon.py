#!/usr/bin/env python3
"""Manual pruner: remove honeymoon thumbnails and manifest entries for files
   no longer present in the honeymoon Drive folder. Not run by scheduled sync.
   Usage:  python scripts/prune_honeymoon.py [--dry-run]
"""
...
FOLDER_ID = os.environ["HONEYMOON_DRIVE_FOLDER_ID"]
