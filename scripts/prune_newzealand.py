#!/usr/bin/env python3
"""Manual pruner: remove newzealand thumbnails and manifest entries for files
   no longer present in the newzealand Drive folder. Not run by scheduled sync.
   Usage:  python scripts/prune_newzealand.py [--dry-run]
"""
...
FOLDER_ID = os.environ["NEWZEALAND_DRIVE_FOLDER_ID"]
...
def save_manifest(entries: dict) -> None:
    """Write entries in the same capture-time order used by the sync."""
